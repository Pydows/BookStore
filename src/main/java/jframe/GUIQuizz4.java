...
public class GUIQuizz4 {
	...
	private void initialize() {
		// D�finissez le frame
				...
				JLabel lblNewLabel = new JLabel("Quel programme t�l� vous pla�t le plus ? ");
				...
				rdbtnamourpre.setActionCommand("amour+nature+");
				...
				rdbtnenquete.setActionCommand("enquete+criminel+");
				...
				rdbtnhistoire.setActionCommand("historique+secret+");
					...
					public void actionPerformed(ActionEvent e) {
						if (e.getActionCommand().equals("Valider")) {
							...
							/*if(Q4 == "marseillais") {
								...
								System.out.println("Vous pr�ferez " + Q4);
							}*/
							GUIAffichageLivres.setRequete(GUIAffichageLivres.getRequete()+Q4);
