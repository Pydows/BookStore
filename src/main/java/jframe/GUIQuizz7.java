...
public class GUIQuizz7 {
	...
	private void initialize() {
		...
		btnNewButton.setActionCommand("a remplir");
		...
		btnNewButton_1.setActionCommand("xxxxx");
		...
		btnNewButton_2.setActionCommand("xxxxx");
		...
		btnNewButton_3.setActionCommand("xxxxx");
		...
		btnNewButton_4.setActionCommand("xxxxx");
		...
		btnNewButton_5.setActionCommand("xxxxx");
